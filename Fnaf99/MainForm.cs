            ...
            new Thread(() =>
                 {
                     ...
                     p.StartInfo.WorkingDirectory = Path.GetDirectoryName(Process.GetCurrentProcess().MainModule.FileName) + "\\Dump";
                        ...
                        if (Actor.IsA("Class /Script/Engine.Actor"))
                        {
                            ...
                            else
                            {
                               ...
                               objects.Add(newObject);
                                ...
                                {
                                    alreadyDumpedBlueprints[realActor.ClassName].position = realActor.K2_GetActorLocation();
                                    alreadyDumpedBlueprints[realActor.ClassName].rotation = realActor.K2_GetActorRotation();
                                    alreadyDumpedBlueprints[realActor.ClassName].scale = realActor.GetActorScale3D();
                                    objects.Add(alreadyDumpedBlueprints[realActor.ClassName]);
                                    return;
                                }
                                ...
                                {
                                    UEObjectInfo uEObjectInfo = new UEObjectInfo();
                                    newObject.type = "dummy";
